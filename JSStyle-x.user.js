...
// @updateURL    https://github.com/TeriFash/x.scripts.user/row/master/JSStyle-x.user.js
// @downloadURL  https://github.com/TeriFash/x.scripts.user/row/master/JSStyle-x.user.js
